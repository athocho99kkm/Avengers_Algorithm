...
<section class="form-container" style="background-color: lightcyan;">
   ...
   <form action="" method="post" class="frm">
      ...
      <input type="password" name="pass" required placeholder="Enter your password" class="box frm1" maxlength="50" oninput="this.value = this.value.replace(/\s/g, '')">
      <input type="password" name="cpass" required placeholder="Confirm your password" class="box frm1" maxlength="50" oninput="this.value = this.value.replace(/\s/g, '')">
      <input type="submit" value="register now" name="submit" class="btn frm1">
